...
namespace ArPaint.Infrastructure
{
    public class BootstrapInstaller : MonoInstaller
    {
        ...
        public override void InstallBindings()
        {
            ...
            Container.Bind<FirebaseApp>().FromMethod(_ => FirebaseApp.DefaultInstance).AsSingle();
            Container.Bind<FirebaseAuth>().FromMethod(_ => FirebaseAuth.DefaultInstance).AsSingle();
            Container.Bind<FirebaseFirestore>().FromMethod(_ => FirebaseFirestore.DefaultInstance).AsSingle();
            Container.Bind<FirebaseStorage>().FromMethod(_ => FirebaseStorage.DefaultInstance).AsSingle();
            ...
            Container.Bind<IAuthSystem>().To<AuthService>().AsSingle();
